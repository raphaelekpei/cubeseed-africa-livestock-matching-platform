"""
Data Loader for livestock-matching-table
Loads data from Excel into a single DynamoDB table with embedded seller information
"""
import boto3
import openpyxl
import random
...
try:
    ...
    print(f"Deleted {len(items_to_delete)} existing items")
